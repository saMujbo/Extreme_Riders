        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <h2 className="mb-8 text-3xl font-extrabold tracking-tight text-ink text-balance lg:text-5xl">
              Ven a vernos{" "}
              <span className="text-carmine">en persona.</span>
            </h2>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-sm font-bold text-ink">Dirección</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-sm font-bold text-ink">Teléfono</h3>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="rounded-2xl bg-carmine p-8 text-center lg:p-12">
              <h3 className="mb-4 text-2xl font-extrabold text-primary-foreground text-balance lg:text-3xl">
                Escríbenos ahora y revisamos tu bici hoy mismo.
              </h3>
              <p className="mb-8 text-primary-foreground/80">
                Respuesta rápida. Sin compromiso. Solo asesoría honesta.
              </p>
              <a
                href={WHATSAPP_URL}
                target="_blank"
